...
public class Simple_ques extends AppCompatActivity implements View.OnClickListener, TextToSpeech.OnInitListener {

    TextView t_ques, t_ans, t_length, t_index;
    Button b_left, b_show, b_right,b_play,b_stop;
    String[] sim_ques, sim_ans;
    int index;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        index = 0;
        sim_ques = getResources().getStringArray(R.array.simple_ques);
        sim_ans = getResources().getStringArray(R.array.simple_ans);
        ...
        t_ques.setText(sim_ques[index]);
        t_index.setText(String.valueOf(index + 1));
        Log.d(tag, "index in onCreate : " + index);

        t_ans.setText(R.string.key);
        t_length.setText(String.valueOf(sim_ques.length));
    ...
    public void onClick(View v) {
        if (!((index < 0) || (index > sim_ques.length))) {
            switch (v.getId()) {
                ...
                case R.id.button_right:
                    ...
                    if (index == (sim_ques.length) - 1) break;
                    t_ans.setText(R.string.key);
                    index++;
                    t_ques.setText(sim_ques[index]);
                    t_index.setText(String.valueOf(index + 1));
